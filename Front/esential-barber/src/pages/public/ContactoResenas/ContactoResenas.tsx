  ...
  <div style={{background:'#121212', minHeight:'100vh', color:'#fff', padding:'0', fontFamily:'inherit', display:'flex', alignItems:'center', justifyContent:'center'}}>
    <div style={{maxWidth:1200, margin:'0 auto', padding:'3rem 2vw 2rem 2vw', display:'flex', flexWrap:'wrap', gap:'2.5rem', alignItems:'center', justifyContent:'center'}}>
      ...
      <div style={{flex:'1 1 340px', minWidth:320, maxWidth:420, display:'flex', flexDirection:'column', gap:'2.5rem'}}>
        <div>
          <span style={{color:'var(--primary-color)', fontWeight:700, fontSize:'1rem', letterSpacing:1, display:'flex', alignItems:'center', gap:8, marginBottom:12}}>
        ...
        <div style={{display:'flex', flexDirection:'column', gap:'1.5rem', fontSize:'1.08rem'}}>
          <div style={{display:'flex', alignItems:'flex-start', gap:16}}>
            <span style={{background:'#222', color:'var(--primary-color)', borderRadius:8, width:38, height:38, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.3rem'}}><FaMapMarkerAlt/></span>
            <span>
          ...
          <div style={{display:'flex', alignItems:'flex-start', gap:16}}>
            <span style={{background:'#222', color:'var(--primary-color)', borderRadius:8, width:38, height:38, display:'flex', alignItems:'center', justifyContent:'center', fontSize:'1.3rem'}}><FaEnvelope/></span>
            <span>
        ...
        <div style={{display:'flex', gap:'1rem', flexWrap:'wrap', marginTop:'1.2rem'}}>
          <button style={{background:'none', color:'#fff', border:'2px solid var(--primary-color)', borderRadius:6, padding:'0.5em 1.2em', fontWeight:600, fontSize:'1em', cursor:'pointer', display:'flex', alignItems:'center', gap:8}}><FaFacebookF/> Facebook</button>
<button style={{background:'none', color:'#fff', border:'2px solid var(--primary-color)', borderRadius:6, padding:'0.5em 1.2em', fontWeight:600, fontSize:'1em', cursor:'pointer', display:'flex', alignItems:'center', gap:8}}><FaInstagram/> Instagram</button>
<button style={{background:'none', color:'#fff', border:'2px solid var(--primary-color)', borderRadius:6, padding:'0.5em 1.2em', fontWeight:600, fontSize:'1em', cursor:'pointer', display:'flex', alignItems:'center', gap:8}}><FaTiktok/> Tiktok</button>
<button style={{background:'none', color:'#fff', border:'2px solid var(--primary-color)', borderRadius:6, padding:'0.5em 1.2em', fontWeight:600, fontSize:'1em', cursor:'pointer', display:'flex', alignItems:'center', gap:8}}><FaTwitter/> Twitter</button>
        </div>
      </div>
      {/* Columna Derecha */}
      <div style={{flex:'1 1 340px', minWidth:320, maxWidth:500, display:'flex', flexDirection:'column', gap:'2.5rem', justifyContent:'flex-start'}}>
        ...
        <div style={{flex:1, display:'flex', alignItems:'center', justifyContent:'center'}}>
          <a href="https://www.google.com/maps?q=4+Paseo+Dr.+Revuelta,+Begíjar,+Andalucía" target="_blank" rel="noopener noreferrer" style={{width:'100%', maxWidth:400, minHeight:260, background:'radial-gradient(circle at 60% 40%, rgba(33,150,243,0.2) 0%, #121212 80%)', borderRadius:'1rem', display:'flex', alignItems:'center', justifyContent:'center', position:'relative', textDecoration:'none', cursor:'pointer'}}>
            <FaMapMarkerAlt style={{position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', color:'var(--primary-color)', fontSize:'3.5rem', filter:'var(--shadow-primary-pin)'}}/>
          </a>
        </div>
      </div>
    </div>
