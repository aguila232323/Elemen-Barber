        ...
        <div style={{background:'#222', borderRadius:'1rem', padding:'2rem 2.5rem', marginBottom:'1.5rem', width:'100%', maxWidth:400, marginTop:'4.5rem'}}>
          <table style={{width:'100%', color:'#fff', fontSize:'1.08rem', borderCollapse:'collapse'}}>
            <tbody>
              ...
              <tr><td style={{color:'#aaa', padding:'0.3em 0'}}>Mar:</td><td style={{textAlign:'right', fontWeight:600, padding:'0.3em 0'}}>10:00 – 20:00</td></tr>
              <tr><td style={{color:'#aaa', padding:'0.3em 0'}}>Mié:</td><td style={{textAlign:'right', fontWeight:600, padding:'0.3em 0'}}>10:00 – 20:00</td></tr>
              <tr><td style={{color:'#aaa', padding:'0.3em 0'}}>Jue:</td><td style={{textAlign:'right', fontWeight:600, padding:'0.3em 0'}}>10:00 – 20:00</td></tr>
              <tr><td style={{color:'#aaa', padding:'0.3em 0'}}>Vie:</td><td style={{textAlign:'right', fontWeight:600, padding:'0.3em 0'}}>10:00 – 20:00</td></tr>
              <tr><td style={{color:'#aaa', padding:'0.3em 0'}}>Sáb:</td><td style={{textAlign:'right', fontWeight:600, padding:'0.3em 0'}}>10:00 – 17:00</td></tr>
              <tr><td style={{color:'#aaa', padding:'0.3em 0'}}>Dom:</td><td style={{textAlign:'right', fontWeight:600, padding:'0.3em 0'}}>10:00 – 17:00</td></tr>
            </tbody>
          </table>
        </div>
